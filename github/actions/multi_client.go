...
func (m *MultiClient) GetClientFor(ctx context.Context, githubConfigURL string, creds ActionsAuth, namespace string) (*Client, error) {
...
func (m *MultiClient) GetClientFromSecret(ctx context.Context, githubConfigURL, namespace string, secretData KubernetesSecretData) (*Client, error) {
	if len(secretData) == 0 {
