ifdef DOCKER_USER
	...
	NAME ?= avastancu/actions-runner-controller
endif
...
chart-crds:
	...
	cp config/crd/bases/actions.summerwind.dev_autoscalingrunnersets.yaml charts/actions-runner-controller-2/crds/
	cp config/crd/bases/actions.summerwind.dev_autoscalinglisteners.yaml charts/actions-runner-controller-2/crds/
	cp config/crd/bases/actions.summerwind.dev_ephemeralrunnersets.yaml charts/actions-runner-controller-2/crds/
	cp config/crd/bases/actions.summerwind.dev_ephemeralrunners.yaml charts/actions-runner-controller-2/crds/
	rm charts/actions-runner-controller/crds/actions.summerwind.dev_autoscalingrunnersets.yaml
	rm charts/actions-runner-controller/crds/actions.summerwind.dev_autoscalinglisteners.yaml
	rm charts/actions-runner-controller/crds/actions.summerwind.dev_ephemeralrunnersets.yaml
	rm charts/actions-runner-controller/crds/actions.summerwind.dev_ephemeralrunners.yaml
