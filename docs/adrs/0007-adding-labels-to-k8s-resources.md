...
Customers need to provide us with logs so that we can help support and troubleshoot their issues. We need a way for our customers to filter and retrieve the logs we need.
...
This would allow us to ask customers:
...
This way customers don't have to understand ARC moving parts but we still have a
