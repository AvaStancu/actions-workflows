...
const (
	...
	autoscalingRunnerSetFinalizerName = "autoscalingrunnerset.actions.summerwind.dev/finalizer"
...
// +kubebuilder:rbac:groups=actions.summerwind.dev,resources=ephemeralrunnersets,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=actions.summerwind.dev,resources=ephemeralrunnersets/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=actions.summerwind.dev,resources=autoscalinglisteners,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=actions.summerwind.dev,resources=autoscalinglisteners/status,verbs=get;update;patch
...
func (r *AutoscalingRunnerSetReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if autoscalingRunnerSet.RunnerSetSpecHash() != latestRunnerSet.Labels[LabelKeyRunnerSpecHash] {
	...
	if len(oldRunnerSets) > 0 {
		log.Info("Cleanup old ephemeral runner sets")
...
func (r *AutoscalingRunnerSetReconciler) actionsClientFor(ctx context.Context, autoscalingRunnerSet *v1alpha1.AutoscalingRunnerSet) (*actions.Client, error) {
