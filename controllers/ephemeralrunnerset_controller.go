...
const (
	...
	ephemeralRunnerSetFinalizerName      = "ephemeralrunner.actions.summerwind.net/finalizer"
)
...
func (r *EphemeralRunnerSetReconciler) deleteEphemeralRunnerWithActionsClient(ctx context.Context, ephemeralRunner *v1alpha1.EphemeralRunner, actionsClient *actions.Client, log logr.Logger) (bool, error) {
...
func (r *EphemeralRunnerSetReconciler) actionsClientFor(ctx context.Context, rs *v1alpha1.EphemeralRunnerSet) (*actions.Client, error) {
